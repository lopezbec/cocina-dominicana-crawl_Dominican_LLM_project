...
RAW_DIR = REPO_ROOT / "crawler" / "data" / "raw"
    ...
    for pair in pairs:
        ...
        sections.append(
            ...
            <section class="comparison">
              ...
              <div class="meta-grid">
                <div><span>Raw file</span><code>{escape_text(pair.raw_path.relative_to(REPO_ROOT).as_posix())}</code></div>
                <div><span>Processed file</span><code>{escape_text(pair.processed_path.relative_to(REPO_ROOT).as_posix())}</code></div>
              </div>
